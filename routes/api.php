...
Route::get('/transactionsRecup',[TransactionController::class,'indexRecup']);
...
Route::post('/transaction',[TransactionController::class],'index1');
Route::middleware('auth:api')->post('/transactions/filter', [TransactionController::class, 'filterByDate']);
Route::middleware('auth:api')->get('/me', [AuthController::class, 'me']);
Route::post('/transactions', [TransactionController::class, 'store']);
Route::post('/transactionsVente', [TransactionController::class, 'storeVente']);
...
Route::middleware('auth:api')->get('/mes-transactions', [TransactionController::class, 'mesTransactions']);
